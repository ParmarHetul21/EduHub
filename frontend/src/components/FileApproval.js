    ...
    return (
      <>
        ...
        {this.state.checkedToggle === "faculty" ?
            ...
            <div className="faculty-subjectCard-header" style={{marginLeft:'250px'}}>
          <div style={{ flex: 1, marginLeft: "20px" }}>FileName</div>

          <div style={{ flex: 0, marginRight: "40px" }}>Approve</div>

          <div style={{ flex: 0, marginRight: "20px" }}>Reject</div>
        </div>
            {files.map( f => (

                    <div className="faculty-subjectCard" style={{marginLeft:'250px'}} key={f.id}>
                        <h5 style={{ flex: 1, marginLeft: "20px" }}>{f.fileName.split(".")[0]}</h5>
                 
                        <div style={{ flex: 0, marginRight: "70px" }} onClick={(e)=>this.approveFile(e,f.id)}>
                            <img src={Approve} width="25" height="25" alt="Logo" />
                        </div>
                 
                        <div style={{ flex: 0, marginRight: "25px" }}>
                               <img
                                 src={Reject}
                                 width="25"
                                 height="25"
